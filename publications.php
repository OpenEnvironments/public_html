	...
	<tr>
		...
		<table><tr>
			...
			<td style="font-size: 18px; text-align: center;">
				<b>A catalog of data publications, for each publisher, is still under construction.</b><br><br>( if you need anything, mail us at <a href="mailto:support@openenvironments.com?subject=Settings Request">support@openenvironments.com )</a> <br>
